...
namespace D07
{
    ...
    {
        public FinalExam(int ExId, int numOfQst, string exName) : base(ExId, numOfQst, exName)
        {
        }
         ...
         public override void ShowExam()
        {
            ...
            studentAnswers = new Answers(ExID, stdId);
            ...
            foreach (Questions q in ExQuestions)
            {
                try
                {
                    ...
                    studentAnswers?.setStdAnswer(q.QID, std_answer);
